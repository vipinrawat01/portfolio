...
const Home = () => {
    ...
    return (
        <div className='mb-11 md:mb-6 md:mt-16 md:flex w-screen min-h-80 md:min-h-85 top-10 md:top-6 flex-row gap-30 relative' id='home'>  
            ...
            <div className='absolute -mt-40 md:-mt-60 top-40 md:top-80'>
                <div>
                    <h1 className='mt-16 mb-5 md:mt-0 px-4 md:px-48 text-2xl md:text-5xl font-bold text-white'>
                        {"Hi I'm "}<br></br>
                    ...
                    <button 
                        ...
                        className='mt-2 md:mt-4 inline-block ml-4 md:ml-48 px-3 py-1 md:px-4 md:py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-800 transition duration-300'>
                        <p className='text-xs md:text-xl'>View Resume</p>
                    </button>
